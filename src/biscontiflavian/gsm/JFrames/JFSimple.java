...
public class JFSimple extends JFrame {
	...
	private static final long serialVersionUID = 181679082473205968L;
	private JPanel contentPane;
	private static OrdonnancementPOJO ordo;
	private JPanel dernierLabel;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					JFSimple frame = new JFSimple(ordo);
	 ...
	 * Create the frame.
	 */
	public JFSimple(OrdonnancementPOJO ordo) {
		...
		t_arbitres = new JLabel[]{lbl_a1,lbl_a2,lbl_a3,lbl_a4,lbl_a5,lbl_a6,lbl_a7,lbl_a8,lbl_a9,lbl_a10,lbl_a11,lbl_a12,lbl_a13,lbl_a14,lbl_a15,lbl_a16};
		t_cours = new JLabel[]{lbl_c1,lbl_c2,lbl_c3,lbl_c4,lbl_c5,lbl_c6,lbl_c7,lbl_c8,lbl_c9,lbl_c10,lbl_c11,lbl_c12,lbl_c13,lbl_c14,lbl_c15,lbl_c16};
		t_dates = new JLabel[]{lbl_d1,lbl_d2,lbl_d3,lbl_d4,lbl_d5,lbl_d6,lbl_d7,lbl_d8,lbl_d9,lbl_d10,lbl_d11,lbl_d12,lbl_d13,lbl_d14,lbl_d15,lbl_d16};
		t_heures = new JLabel[]{lbl_h1,lbl_h2,lbl_h3,lbl_h4,lbl_h5,lbl_h6,lbl_h7,lbl_h8,lbl_h9,lbl_h10,lbl_h11,lbl_h12,lbl_h13,lbl_h14,lbl_h15,lbl_h16};
	...
	private void afficherResultats(int borneInf, int borneSup)
	{
		...
		if(matchs.length == 15)dernierLabel.setVisible(false);
		else dernierLabel.setVisible(true);
	}
}
